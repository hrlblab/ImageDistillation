...
from utils_med import get_dataset, get_network, get_daparam,\
...
def main(args):
    ...
    for it in range(0, args.num_experts):
        ...
        #     pretrained_dict = \
        #     torch.load("/Data/lmy_workspace/data_distillation/mtt-distillation/model/weights_pathmnist/resnet18_28_1.pth",
        ...
        #     teacher_net.load_state_dict(model_dict, strict=False)
        teacher_net.train()
        lr = args.lr_teacher
